...
{
    [TestMethod]
    public void ParseLogLine_Works()
    {
        ...
        logLine.Should().BeEquivalentTo(new LogLine
        {
            ...
            Domain = "example.net",
            AbsolutePath = "/blog/category/meta/",
            StatusCode = HttpStatusCode.OK
        });
    }

    [TestMethod]
    public void ParseLogLine_WhenNoDomainName_DomainIsNull()
    {
        var parser = new LogLineParser();
    ...
    [TestMethod]
    public void ParseLogLine_WhenQueryParams_DropsQueryParamsFromAbsolutePath()
    {
        var parser = new LogLineParser();
    ...
    public void ParseLogLine_WhenIPv6Address_Works()
    {
        ...
        logLine.Should().BeEquivalentTo(new LogLine
        {
            IpAddress = new IPAddress([0x26, 0x07, 0xf8, 0xb0, 0x40, 0x0d, 0x0c, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x69]),
            Timestamp = new DateTimeOffset(2018, 7, 9, 10, 10, 38, TimeSpan.FromHours(2)),
            HttpMethod = HttpMethod.Get,
            Domain = null,
            AbsolutePath = "/blog/category/meta/",
    ...
    [TestMethod]
    public void ParseLogLine_WhenExtraPartsWorks()
    {
        var parser = new LogLineParser();
